...
const App = () => {
  const posts = [
    {
      id: 1, imageUrl: "https://picsum.photos/2000/2000?grayscale", name: "arcastic_us", likeIt:true,
      postcomment: [
        {
          author: "donalleniii",
          isVerified: true,
    ...
    {
      id: 2, imageUrl: "https://picsum.photos/1900/1900?grayscale", name: "arcastic_us2", likeIt:true,
      postcomment: [
        {
          author: "donalleniii",
          isVerified: true,
    ...
    <div className="app">
      ...
      <main className="main-content">
        <div className="posts-container">
          {posts.map(post => (
            <div key={post.id}>
              <ImagePost key={post.id} imageUrl={post.imageUrl} name={post.name} likeIt={post.likeIt} posts={post.postcomment} />
            </div>
          ))}
        </div>
      </main>
