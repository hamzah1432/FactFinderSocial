    ...
    <div>
      <div className="PostContainer">
        ...
        >
          ...
          <SocialMediaPost posts={posts} name={name} />
        </div>
      </div>
    </div>
  );
...
const SocialMediaPost = ({ posts, name }) => {
  const [comment, setComment] = useState("");
  const [postcomment, setPostcomment] = useState(posts);

  const handleAddComment = () => {
    // here you can add your api to add comment
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.postsSection}>
        <div
          style={{ overflowY: "scroll", height: 427, scrollbarWidth: "none" }}
        >
        ...
        <div style={styles.commentSection}>
          ...
          />
          <button style={styles.postButton} onClick={() => handleAddComment()}>
            Post
          </button>
        </div>
      </div>
